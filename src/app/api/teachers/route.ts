...
export async function POST(req: NextRequest) {
  ...
  const finalUsername = (username && username.trim().toLowerCase()) || `${teacherCode.trim().toLowerCase()}.40010`;
  const finalPassword = password || `${teacherCode.trim().toLowerCase()}@40010`;
